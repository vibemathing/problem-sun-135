...
```json
{
  ...
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "sun-135",
        "url": "http://maths.nju.edu.cn/~zwsun/Square-sum.pdf"
      },
      {
        "retrieved_at": "2026-09-08T08:24:29Z",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): 1-3-5 conjecture. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "1-3-5 conjecture",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "e02b36b2fbcf3b45e078955cae88106306678498a252fbdda09f0503bf37ff6e"
}
```
